...
My name is **Jordan Lin**. I am a first year Computer Science PhD student at Columbia University. Check out my website [here](https://kuanhenglin.github.io)!

My research interests stem from **generative models** to topics such as computer vision, multimodal/4D generation, controllable generation, and interpretability. Particularly, my work revolves around pushing the boundaries and applications of large generative models to allow us to interact with them in a more **human** way.
